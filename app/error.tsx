            ...
            <div className='relative z-10 max-w-2xl w-full text-center'>
                ...
                <div className="mb-8 relative inline-block">
                    <div className="relative">
                        ...
                        {/* Icon container */}
                        <div className="relative w-32 h-32 mx-auto bg-linear-to-br from-red-100 to-orange-100 dark:from-red-900/20 dark:to-orange-900/20 rounded-full flex items-center justify-center border-4 border-red-200 dark:border-red-800">
                            <TriangleAlert
                                size={64}
                ...
                {/* Info Card */}
                <div className="mt-8 p-6 bg--to-r from-sandbrown/10 to-[#f4a261]/10 dark:from-sandbrown/5 dark:to-[#f4a261]/5 border border-sandbrown/20 dark:border-sandbrown/10 rounded-2xl">
