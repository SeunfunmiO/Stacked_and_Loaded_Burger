    ...
    useEffect(() => {
        const fetchOrder = async () => {
            ...
            if (res.orders && res.orders.length > 0) {
                ...
                setOrderNumber(res.orders[0]._id || '')
            }
            setLoading(false)
        }
        fetchOrder()
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        {orders.length > 1 && (
                            <div className="relative">
                                ...
                                <select
                                    ...
                                    className="w-full px-4 py-3 bg-gray-50 dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 rounded-lg text-gray-900 dark:text-white focus:outline-none focus:border-[#dc9457] transition-colors"
                                >
                                    <option value="">Select an order</option>
                                    {orders.map((order) => (
                                        <option key={order._id} value={order._id}>
                                            Order #{order._id || order._id} - {order.status}
                                        </option>
                                    ))}
                                </select>
                            </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            <div className="relative flex-1">
                                ...
                                <input
                                    ...
                                    className="w-full pl-12 pr-4 py-3 bg-gray-50 dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 rounded-lg text-gray-900 dark:text-white placeholder:text-gray-500 focus:outline-none focus:border-[#dc9457] transition-colors"
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="px-8 py-3 bg-gradient-to-r from-[#dc9457] to-[#f4a261] text-white rounded-lg font-semibold hover:opacity-90 transition-all disabled:opacity-50 whitespace-nowrap"
                            >
                ...
                {selectedOrder && (
                    <div className="space-y-6">
                        ...
                        <div className="bg-white dark:bg-neutral-950 rounded-2xl border border-gray-200 dark:border-neutral-800 p-6">
                            <div className="flex items-center justify-between mb-4">
                                <h2 className="text-xl font-bold text-gray-900 dark:text-white">
                                    Order #{selectedOrder._id || selectedOrder._id}
                                </h2>
                            ...
                            <div className="space-y-2 text-sm">
                                <div className="flex items-center text-gray-600 dark:text-gray-400">
                                    <MapPin className="w-4 h-4 mr-2 text-[#dc9457]" />
                                    {selectedOrder.delivery || selectedOrder.delivery || 'Delivery address not available'}
                                </div>
                                <div className="flex items-center text-gray-600 dark:text-gray-400">
                                    <Clock className="w-4 h-4 mr-2 text-[#dc9457]" />
                            ...
                            <div className="relative">
                                ...
                                {(() => {
                                    ...
                                    return (
                                        <>
                                            <div
                                                className="absolute left-6 top-0 w-0.5 bg-gradient-to-b from-[#dc9457] to-[#f4a261] transition-all duration-1000"
                                            ...
                                            <div className="space-y-6">
                                                {timeline.map((step, index) => (
                                                    <div key={index} className="flex items-start relative">
                                                        <div className={`flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center z-10 transition-all ${step.completed
                                                            ? 'bg-gradient-to-r from-[#dc9457] to-[#f4a261]'
                        ...
                        <div className="bg-gradient-to-r from-[#dc9457]/10 to-[#f4a261]/10 dark:from-[#dc9457]/5 dark:to-[#f4a261]/5 border border-[#dc9457]/20 dark:border-[#dc9457]/10 rounded-2xl p-6">
                            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center">
                                <Bike className="w-5 h-5 mr-2 text-[#dc9457]" />
                                Your Delivery Rider
                            </h3>
                            <div className="flex items-center justify-between">
                                ...
                                <a
                                    ...
                                    className="flex items-center px-4 py-2 bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 text-gray-900 dark:text-white rounded-lg font-medium hover:border-[#dc9457] transition-all"
                                >
                            ...
                            <div className="bg-white dark:bg-neutral-950 rounded-2xl border border-gray-200 dark:border-neutral-800 p-6">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="pt-3 border-t border-gray-200 dark:border-neutral-800 flex items-center justify-between">
                                        ...
                                        <p className="text-xl font-bold text-[#dc9457]">
